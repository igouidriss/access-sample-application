...
import { sampleWithRequiredData, sampleWithNewData } from '../table-3.test-samples';

import { Table3FormService } from './table-3-form.service';

describe('Table3 Form Service', () => {
  let service: Table3FormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(Table3FormService);
  });

  describe('Service methods', () => {
    describe('createTable3FormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createTable3FormGroup();
      ...
      it('passing ITable3 should create a new form with FormGroup', () => {
        const formGroup = service.createTable3FormGroup(sampleWithRequiredData);
    ...
    describe('getTable3', () => {
      it('should return NewTable3 for default Table3 initial value', () => {
        const formGroup = service.createTable3FormGroup(sampleWithNewData);

        const table3 = service.getTable3(formGroup) as any;

        expect(table3).toMatchObject(sampleWithNewData);
      });

      it('should return NewTable3 for empty Table3 initial value', () => {
        const formGroup = service.createTable3FormGroup();

        const table3 = service.getTable3(formGroup) as any;

        expect(table3).toMatchObject({});
      });

      it('should return ITable3', () => {
        const formGroup = service.createTable3FormGroup(sampleWithRequiredData);

        const table3 = service.getTable3(formGroup) as any;

        expect(table3).toMatchObject(sampleWithRequiredData);
      });
    });

    describe('resetForm', () => {
      it('passing ITable3 should not enable id FormControl', () => {
        const formGroup = service.createTable3FormGroup();
      ...
      it('passing NewTable3 should disable id FormControl', () => {
        const formGroup = service.createTable3FormGroup(sampleWithRequiredData);
        expect(formGroup.controls.id.disabled).toBe(true);
