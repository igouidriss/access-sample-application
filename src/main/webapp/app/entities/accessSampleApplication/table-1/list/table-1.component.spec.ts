...
import { sampleWithRequiredData } from '../table-1.test-samples';
...
describe('Table1 Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, Table1Component],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.table1s?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to table1Service', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTable1Identifier');
      const id = comp.trackId(0, entity);
      expect(service.getTable1Identifier).toHaveBeenCalledWith(entity);
