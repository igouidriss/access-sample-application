...
import { sampleWithRequiredData, sampleWithNewData } from '../table-1.test-samples';

import { Table1FormService } from './table-1-form.service';

describe('Table1 Form Service', () => {
  let service: Table1FormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(Table1FormService);
  });

  describe('Service methods', () => {
    describe('createTable1FormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createTable1FormGroup();
      ...
      it('passing ITable1 should create a new form with FormGroup', () => {
        const formGroup = service.createTable1FormGroup(sampleWithRequiredData);
    ...
    describe('getTable1', () => {
      it('should return NewTable1 for default Table1 initial value', () => {
        const formGroup = service.createTable1FormGroup(sampleWithNewData);

        const table1 = service.getTable1(formGroup) as any;

        expect(table1).toMatchObject(sampleWithNewData);
      });

      it('should return NewTable1 for empty Table1 initial value', () => {
        const formGroup = service.createTable1FormGroup();
      ...
      it('should return ITable1', () => {
        const formGroup = service.createTable1FormGroup(sampleWithRequiredData);

        const table1 = service.getTable1(formGroup) as any;

        expect(table1).toMatchObject(sampleWithRequiredData);
      });
    });

    describe('resetForm', () => {
      it('passing ITable1 should not enable id FormControl', () => {
        const formGroup = service.createTable1FormGroup();
      ...
      it('passing NewTable1 should disable id FormControl', () => {
        const formGroup = service.createTable1FormGroup(sampleWithRequiredData);
        expect(formGroup.controls.id.disabled).toBe(true);
