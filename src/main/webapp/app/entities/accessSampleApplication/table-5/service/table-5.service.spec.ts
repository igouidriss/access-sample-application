...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../table-5.test-samples';

import { Table5Service, RestTable5 } from './table-5.service';

const requireRestSample: RestTable5 = {
...
describe('Table5 Service', () => {
  let service: Table5Service;
  let httpMock: HttpTestingController;
  let expectedResult: ITable5 | ITable5[] | boolean | null;
  ...
  beforeEach(() => {
    ...
    expectedResult = null;
    service = TestBed.inject(Table5Service);
  ...
  describe('Service methods', () => {
    ...
    it('should create a Table5', () => {
      const table5 = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(table5).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Table5', () => {
      const table5 = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(table5).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should partial update a Table5', () => {
    ...
    it('should return a list of Table5', () => {
      const returnedFromService = { ...requireRestSample };
    ...
    describe('addTable5ToCollectionIfMissing', () => {
      it('should add a Table5 to an empty array', () => {
        const table5: ITable5 = sampleWithRequiredData;
        expectedResult = service.addTable5ToCollectionIfMissing([], table5);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table5);
      });

      it('should not add a Table5 to an array that contains it', () => {
        const table5: ITable5 = sampleWithRequiredData;
        const table5Collection: ITable5[] = [
          {
            ...table5,
          },
          sampleWithPartialData,
        ];
        expectedResult = service.addTable5ToCollectionIfMissing(table5Collection, table5);
        expect(expectedResult).toHaveLength(2);
      });

      it("should add a Table5 to an array that doesn't contain it", () => {
        const table5: ITable5 = sampleWithRequiredData;
        const table5Collection: ITable5[] = [sampleWithPartialData];
        expectedResult = service.addTable5ToCollectionIfMissing(table5Collection, table5);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table5);
      });

      it('should add only unique Table5 to an array', () => {
        const table5Array: ITable5[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const table5Collection: ITable5[] = [sampleWithRequiredData];
        expectedResult = service.addTable5ToCollectionIfMissing(table5Collection, ...table5Array);
        expect(expectedResult).toHaveLength(3);
      });

      it('should accept varargs', () => {
        const table5: ITable5 = sampleWithRequiredData;
        const table52: ITable5 = sampleWithPartialData;
        expectedResult = service.addTable5ToCollectionIfMissing([], table5, table52);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(table5);
        expect(expectedResult).toContain(table52);
      });

      it('should accept null and undefined values', () => {
        const table5: ITable5 = sampleWithRequiredData;
        expectedResult = service.addTable5ToCollectionIfMissing([], null, table5, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(table5);
      });

      it('should return initial array if no Table5 is added', () => {
        const table5Collection: ITable5[] = [sampleWithRequiredData];
        expectedResult = service.addTable5ToCollectionIfMissing(table5Collection, undefined, null);
        expect(expectedResult).toEqual(table5Collection);
      });
    });

    describe('compareTable5', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareTable5(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareTable5(entity1, entity2);
        const compareResult2 = service.compareTable5(entity2, entity1);
