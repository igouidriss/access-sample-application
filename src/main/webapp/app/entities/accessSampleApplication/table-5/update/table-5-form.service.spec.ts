...
import { sampleWithRequiredData, sampleWithNewData } from '../table-5.test-samples';

import { Table5FormService } from './table-5-form.service';

describe('Table5 Form Service', () => {
  let service: Table5FormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(Table5FormService);
  });

  describe('Service methods', () => {
    describe('createTable5FormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createTable5FormGroup();
      ...
      it('passing ITable5 should create a new form with FormGroup', () => {
        const formGroup = service.createTable5FormGroup(sampleWithRequiredData);
    ...
    describe('getTable5', () => {
      it('should return NewTable5 for default Table5 initial value', () => {
        const formGroup = service.createTable5FormGroup(sampleWithNewData);

        const table5 = service.getTable5(formGroup) as any;

        expect(table5).toMatchObject(sampleWithNewData);
      });

      it('should return NewTable5 for empty Table5 initial value', () => {
        const formGroup = service.createTable5FormGroup();
      ...
      it('should return ITable5', () => {
        const formGroup = service.createTable5FormGroup(sampleWithRequiredData);

        const table5 = service.getTable5(formGroup) as any;

        expect(table5).toMatchObject(sampleWithRequiredData);
      });
    });

    describe('resetForm', () => {
      it('passing ITable5 should not enable id FormControl', () => {
        const formGroup = service.createTable5FormGroup();
      ...
      it('passing NewTable5 should disable id FormControl', () => {
        const formGroup = service.createTable5FormGroup(sampleWithRequiredData);
        expect(formGroup.controls.id.disabled).toBe(true);
