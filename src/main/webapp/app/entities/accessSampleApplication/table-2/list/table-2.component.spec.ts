...
import { sampleWithRequiredData } from '../table-2.test-samples';
...
describe('Table2 Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, Table2Component],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.table2s?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to table2Service', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTable2Identifier');
      const id = comp.trackId(0, entity);
      expect(service.getTable2Identifier).toHaveBeenCalledWith(entity);
