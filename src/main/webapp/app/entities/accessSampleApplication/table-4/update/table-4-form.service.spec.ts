...
import { sampleWithRequiredData, sampleWithNewData } from '../table-4.test-samples';

import { Table4FormService } from './table-4-form.service';

describe('Table4 Form Service', () => {
  let service: Table4FormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(Table4FormService);
  });

  describe('Service methods', () => {
    describe('createTable4FormGroup', () => {
      it('should create a new form with FormControl', () => {
        const formGroup = service.createTable4FormGroup();
      ...
      it('passing ITable4 should create a new form with FormGroup', () => {
        const formGroup = service.createTable4FormGroup(sampleWithRequiredData);
    ...
    describe('getTable4', () => {
      it('should return NewTable4 for default Table4 initial value', () => {
        const formGroup = service.createTable4FormGroup(sampleWithNewData);

        const table4 = service.getTable4(formGroup) as any;

        expect(table4).toMatchObject(sampleWithNewData);
      });

      it('should return NewTable4 for empty Table4 initial value', () => {
        const formGroup = service.createTable4FormGroup();

        const table4 = service.getTable4(formGroup) as any;

        expect(table4).toMatchObject({});
      });

      it('should return ITable4', () => {
        const formGroup = service.createTable4FormGroup(sampleWithRequiredData);

        const table4 = service.getTable4(formGroup) as any;

        expect(table4).toMatchObject(sampleWithRequiredData);
      });
    });

    describe('resetForm', () => {
      it('passing ITable4 should not enable id FormControl', () => {
        const formGroup = service.createTable4FormGroup();
      ...
      it('passing NewTable4 should disable id FormControl', () => {
        const formGroup = service.createTable4FormGroup(sampleWithRequiredData);
        expect(formGroup.controls.id.disabled).toBe(true);
